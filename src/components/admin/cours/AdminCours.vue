...
export default {
  ...
  methods: {
    ...
    getFileURL(coursPath) {
      return `https://57.129.14.178:5000/cours/open?file=${coursPath}`;
    },
    valide(name, teacher, promotion, type, matter, year, author, id) {
      axios.post(`https://57.129.14.178:5000/cours/valide`, {
            name: name,
            teacher: teacher,
            promotion: promotion,
            type: type,
  ...
  mounted() {
    ...
    axios.get("https://57.129.14.178:5000/admin/cours").then((res) => {
